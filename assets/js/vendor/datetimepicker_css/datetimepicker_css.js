...
function RenderCssCal(bNewCal) {
	...
	if (Cal.Scroller=="DROPDOWN") {
		vCalHeader+="<td align='center'><select name=\"MonthSelector\" class=\"datetime_select\" onChange=\"javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();\">\n";
		for (i=0;i<12;i++) {
			if (i==Cal.Month)
				SelectStr="Selected";
			else
		...
		vCalHeader+="<td align='center'><select name=\"YearSelector\" size=\"1\" class=\"datetime_select\" onChange=\"javascript:Cal.SwitchYear(this.value);RenderCssCal();\">\n";
  ...
  //******************End Month and Year selector in arrow******************************
	...
	if (Cal.ShowTime) 
	{
		...
		vCalTime+="<td align='center' width='22px'><input type='text' name='hour' class='datetime_input' maxlength=2 size=1 style=\"WIDTH:22px\" value="+showHour+" onChange=\"javascript:Cal.SetHour(this.value)\">";
		vCalTime+="</td><td align='center' style='font-size:150%; font-weight:bold;'>:</td><td align='center' width='22px'>";
		vCalTime+="<input type='text' name='minute' class='datetime_input' maxlength=2 size=1 style=\"WIDTH: 22px\" value="+Cal.Minutes+" onChange=\"javascript:Cal.SetMinute(this.value)\">";
