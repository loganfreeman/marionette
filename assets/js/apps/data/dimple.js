(function(){
    // This code should support any data in this structure changing the data
	// here
    ...
    // Also the "bar" elements must have the correct value (sum of previous
	// "bar"
    ...
    data.forEach(function (d, i) {
      ...
      waterfallData.push({
        ...
        y: padBase
          ...
          + (d.value < 0 ? d.value : 0),
        series: "pad" });
      // Add the bar itself. The values are always positive here. The labels
		// in
