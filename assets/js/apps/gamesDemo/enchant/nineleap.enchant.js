/**
 * @fileOverview nineleap.enchant.js
 * @version 0.3.4 (2013/04/03)
 * @requires enchant.js v0.6.3 or later
 * 
 * @description enchant.js extension for 9leap.net 9leap.net 向けの enchant.js
 *              拡張プラグイン。 core.end の引数にスコアと結果の文字列を渡すことで、ランキングに登録できる。
 ...
 * 
 * core.onload = function(){ // executed after player pushed "START" // ...
...
define([ 'enchant' ], function(enchant) {
	(function() {
		 ...
		 */
		enchant.nineleap = {
			assets : [ 'assets/js/apps/gamesDemo/enchant/images/start.png', 'assets/js/apps/gamesDemo/enchant/images/end.png' ]
		};
		...
		enchant.nineleap.Core = enchant.Class.create(enchant.Core, {
			/**
			 * start, gameover の画像を表示し、 最後にスコアを送信するように拡張された Core クラス
			 * 
			 * @param width
			 * @param height
			 * @constructs
			...
			initialize : function(width, height) {
				...
				this.addEventListener('load', function() {
					...
					this.startScene.image = this.assets['assets/js/apps/gamesDemo/enchant/images/start.png'];
					...
					this.endScene.image = this.assets['assets/js/apps/gamesDemo/enchant/images/end.png'];
			...
			_requestPreload : function() {
				var o = {};
				var loaded = 0, len = 0, loadFunc = function() {
