define([ 'vendor/flash' ], function() {
	...
	addListeners = function() {
		...
		document.body.addEventListener('touchmove', function(e) {
			e.offsetX = e.pageX;
			e.offsetY = e.pageY;
			var event = flash.events.normalizeEvent(e);
		...
		*/
		...
		$('body').on('touchmove.flashDemo mousemove.flashDemo', function(e) {
			e.offsetX = e.pageX;
			e.offsetY = e.pageY;
			var event = flash.events.normalizeEvent(e);
			event.offsetX = e.pageX / stage.scale;
	...
	var particles = [];
	var assetList = new AssetsList({
		scale : stage.pixelScale
	}, 'assets/js/apps/gamesDemo/flash/assets.json', addListeners);
