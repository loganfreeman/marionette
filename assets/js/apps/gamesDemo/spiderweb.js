define(['verlet'], function(VerletJS) {
	...
	var run = function() {
		...
		var canvas = document.getElementById("spiderweb");
		...
		spider.drawConstraints = function(ctx, composite) {
			...
			for (i = 3; i < composite.constraints.length; ++i) {
				...
				if (constraint instanceof DistanceConstraint) {
					...
					// draw legs
					if ((i >= 2 && i <= 4) || (i >= (2 * 9) + 1 && i <= (2 * 9) + 2) || (i >= (2 * 17) + 1 && i <= (2 * 17) + 2) || (i >= (2 * 25) + 1 && i <= (2 * 25) + 2)) {
						ctx.save();
						constraint.draw(ctx);
						ctx.strokeStyle = "#000";
						ctx.lineWidth = 3;
						ctx.stroke();
						ctx.restore();
					} else if ((i >= 4 && i <= 6) || (i >= (2 * 9) + 3 && i <= (2 * 9) + 4) || (i >= (2 * 17) + 3 && i <= (2 * 17) + 4) || (i >= (2 * 25) + 3 && i <= (2 * 25) + 4)) {
						ctx.save();
						constraint.draw(ctx);
						ctx.strokeStyle = "#000";
						ctx.lineWidth = 2;
						ctx.stroke();
						ctx.restore();
					} else if ((i >= 6 && i <= 8) || (i >= (2 * 9) + 5 && i <= (2 * 9) + 6) || (i >= (2 * 17) + 5 && i <= (2 * 17) + 6) || (i >= (2 * 25) + 5 && i <= (2 * 25) + 6)) {
						ctx.save();
						ctx.strokeStyle = "#000";
						ctx.lineWidth = 1.5;
						ctx.stroke();
