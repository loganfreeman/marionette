...
var rootcondition = '<table><tr><td class="seperator" ><img src="assets/js/apps/conditionbuilder/img/remove.png" alt="Remove" class="remove" /><select><option value="and">And</option><option value="or">Or</option></select></td>';
rootcondition += '<td><div class="querystmts"></div><div><img class="add" src="assets/js/apps/conditionbuilder/img/add.png" alt="Add" /> <button class="addroot">+()</button></div>';
rootcondition += '</td></tr></table>';

var statement = '<div><img src="assets/js/apps/conditionbuilder/img/remove.png" alt="Remove" class="remove" />'
