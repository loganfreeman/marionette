define([ 'app' , 'tpl!apps/algo-visual/index.html', 'css!apps/algo-visual/visualization',
        'apps/algo-visual/BinarySearchTree',
        'apps/algo-visual/RedBlackTree'], function(App, tpl) {
	App.module('ModuleName', function(ModuleName, App, Backbone, Marionette, $, _) {
		...
		ModuleName.controller = {
			show : function() {
				App.navigate("algo-visual");
				App.mainRegion.show(new ModuleName.MainView());
			}
		}

		App.on("algo-visual:show", function() {
		...
		ModuleName.addInitializer(function() {
