...
function AffinityPropagation(similarity_array, points_controller) {
	...
	/**
	 * Finding the max element in an array from: From
	 * http://ejohn.org/blog/fast-javascript-maxmin The other stuff is what I
	 * added for the affinity propogation algorithm.
	 * 
	 * TODO: If k = 0 then k - 1 = -1 and this would probably give an error or
	 * worse undefined behaviour. if k = lengthOfArray then k + 1 >
	 * lengthOfArray and this would be out of bounds and also give an error.
	 */
