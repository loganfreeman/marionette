define(['angular', 'angular-ui', 'css!../css/ribbons', 'css!../css/colorgame'], function (angular, ui) {
    'use strict';

    // Declare app level module which depends on filters, and services
    var colorGameApp = angular.module('colorGame', ['ui']);

    colorGameApp.controller('ColorGameCtrl',
        function ColorGameCtrl($scope) {
            $scope.UI = {};
            $scope.game = {};
            $scope.totalProblem = 100;
            $scope.rightScore = 5; // how much score you get when get a correct
									// answer
            $scope.wrongScore = -3; // how much score you get when get a wrong
            // answer
            $scope.totalTime = 30;
            ...
            $scope.stopGame = function () {
                ...
                $scope.game.previousColor = ""; // to prevent same color
												// multiple
                // times
                $scope.game.answer = "";
