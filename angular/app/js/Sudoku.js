define([ 'angular', 'angular-resource', 'css!../partials/sudoku/style' ], function(angular) {
	    ...
	    function search_unique_cases(rows){
	    	...
	    	for(var l=0; l<9; l++){
	    		...
	    		for(var p=0; p<line_pos.length; p++){
	    			var nbr_cells = 0; // nbr cells possibly receiving this
										// value
	    			var mem_c = 0; // memorize the column that could receive
									// this value
	    			for(var c=0; c<9 && nbr_cells<2; c++){
	    				if(rows[l].columns[c].value == ""){
	    					var m;// need to check if this value is a
									// possibility for this cell
	    	...
	    	for(var c=0; c<9; c++){    	    			    	
	    		...
	    		for(var p=0; p<column_pos.length; p++){
	    			var nbr_cells = 0; // nbr cells possibly receiving this
										// value
	    			var mem_l = 0; // memorize the line that could receive this
									// value
